...
---@field aftermath? fun():nil Will be run after the Jokers are fused
...
---Original fusion registry function, now deprecated. You can use [this regex](https://regex101.com/r/msZHKS/2/substitution) to convert it and avoid warning messages.
